<template>
  <LayoutHeader>
    ...
    <template v-if="!errorTitle" #right-header>
      ...
      />
         <!-- To create gamma proposal in Quick entry -->
       <div class="ml-auto">
            <Button
        ...
        <div class="flex flex-col gap-2.5 truncate text-ink-gray-9">
          ...
          <div class="flex gap-1.5">
            <Button
              ...
              @click="triggerCall"
            />
<!-- To check if email and website exist -->
  ...
  <!-- For Create Gamma Proposal to quick entry -->
  <GammaModal
    v-if="showDealModal"
...
import GammaProposalIcon from '../components/Icons/GammaProposalIcon.vue'
...
const dealContacts = createResource({
  ...
  cache: ['deal_contacts', props.quotationId],
  transform: (data) => {
