<template>
  <LayoutHeader>
    <template #left-header>
      <ViewBreadcrumbs v-model="viewControls" routeName="Project Tasks" />
    </template>
    ...
    <template #title="{ titleField, itemName }">
      <div class="flex items-center gap-2">
        <div v-if="titleField === 'status'">
          <ProjectTaskStatusIcon :status="getRow(itemName, titleField).label" />
        </div>
  ...
  <CreateNewProjectTaskModal
    v-if="showTaskModal"
    v-model="showTaskModal"
    v-model:reloadTasks="tasks"
    :task="task" />

  <!-- Old Project Task Modal -->
  <!-- <CreateNewProjectTaskModal
    v-if="showTaskModal"
    v-model="showTaskModal"
    v-model:reloadTasks="tasks"
...
import ProjectTasksListView from '@/components/ListViews/ProjectTasksListView.vue'
import KanbanView from '@/components/Kanban/KanbanView.vue'
import CreateNewProjectTaskModal from '@/components/Modals/CreateNewProjectTaskModal.vue'
