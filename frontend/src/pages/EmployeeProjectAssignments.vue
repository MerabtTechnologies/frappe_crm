<template>
  <LayoutHeader>
    <template #left-header>
      <ViewBreadcrumbs v-model="viewControls" routeName="Employee Project Assignments" />
    </template>
  ...
  <EmployeeProjectAssignmentsListView
    ref="dealsListView"
  ...
  <div v-else-if="deals.data" class="flex h-full items-center justify-center">
    ...
    >
      ...
      <span>{{ __('No {0} Found', [__('Employee Project Assignments')]) }}</span>
      <Button
        :label="__('Create')"
        iconLeft="plus"
        @click="showDealModal = true"
...
import EmployeeProjectAssignmentsListView from '@/components/ListViews/EmployeeProjectAssignmentsListView.vue'
import KanbanView from '@/components/Kanban/KanbanView.vue'
import CreateNewProjectAssignment from '@/components/Modals/CreateNewProjectAssignment.vue'
...
const { getFormattedPercent, getFormattedFloat, getFormattedCurrency } =
  getMeta('Employee Project Assignment')
...
function showNote(name) {
  showModal({
    ...
    title: 'Note',
    defaults: {
      reference_doctype: 'Employee Project Assignment',
