  ...
  <div v-if="doc.name" class="flex h-full overflow-hidden">
    ...
    <Resizer side="right" class="flex flex-col justify-between border-l">
      <div
        ...
        @click="copyToClipboard(assignmentId)"
      >
        {{ __(assignmentId) }}
      </div>
      <FileUploader
        ...
        <template #default="{ openFileSelector, error }">
          <div class="flex items-center justify-start gap-5 border-b p-5">
            ...
            <div class="flex flex-col gap-2.5 truncate text-ink-gray-9">
              <Tooltip :text="doc.name || __('Set a Employee Project Assignment')">
...
const { doctypeMeta, getFields } = getMeta('Employee Project Assignment')
...
onMounted(() => {
  $socket.on('employee_project_assignment_created', () => {
    toast.success(__('Employee Project Assignment created successfully'))
  })
})

onBeforeUnmount(() => {
  $socket.off('employee_project_assignment_created')
})
