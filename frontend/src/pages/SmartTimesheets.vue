<template>
  <LayoutHeader>
    <template #left-header>
      <ViewBreadcrumbs v-model="viewControls" routeName="Smart Timesheets" />
    </template>
  ...
  <div v-else-if="deals.data" class="flex h-full items-center justify-center">
    ...
    >
      ...
      <span>{{ __('No {0} Found', [__('Smart Timesheets')]) }}</span>
      <Button
        :label="__('Create')"
        iconLeft="plus"
        @click="showDealModal = true"
...
import SmartTimesheetListView from '@/components/ListViews/SmartTimesheetListView.vue'
import KanbanView from '@/components/Kanban/KanbanView.vue'
import CreateSmartTimesheet from '@/components/Modals/CreateSmartTimesheet.vue'
...
function showNote(name) {
  showModal({
    ...
    title: 'Note',
    defaults: {
      reference_doctype: 'Smart Timesheet',
