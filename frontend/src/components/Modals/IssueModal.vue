...
const tabs = createResource({
  ...
  cache: ['QuickEntry', 'Issue'],
  params: { doctype: 'Issue', type: 'Quick Entry' },
  auto: true,
  transform: (_tabs) => {
...
onMounted(() => {
  ...
  // deal.doc = {
  //   ...deal.doc,
  //   ...JSON.parse(JSON.stringify(issue.doc)),
  // } // Deep copy to make it reactive

  // if(!props.data_edit){
  //   deal.doc = { ...deal.doc, ...props.defaults }
  // }
  // deal.doc = { ...deal.doc, ...props.defaults }
