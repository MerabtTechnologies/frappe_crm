        ...
        <div class="mb-5 flex items-center justify-between">
          <div>
            <h3 class="text-2xl font-semibold leading-6 text-ink-gray-9">
              {{ __('Create Employee Project Assignment') }}
            </h3>
          </div>
...
const tabs = createResource({
  ...
  cache: ['QuickEntry', 'Employee Project Assignment'],
  params: { doctype: 'Employee Project Assignment', type: 'Quick Entry' },
  auto: true,
  transform: (_tabs) => {
...
async function createDeal() {
  ...
  createResource({
    ...
    params: { args: deal.doc, doctype: 'Employee Project Assignment' },
    auto: true,
    validate() {
      error.value = null
...
function openQuickEntryModal() {
  ...
  quickEntryProps.value = { doctype: 'Employee Project Assignment ' }
